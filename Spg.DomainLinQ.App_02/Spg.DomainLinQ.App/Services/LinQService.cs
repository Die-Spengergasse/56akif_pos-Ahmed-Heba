...
namespace Spg.DomainLinQ.App.Services
{
    ...
    public class LinQService
    {
        ...
        public void Start()
        {
            ...
            List <User> result02 = _db.Users.Where(u => u.LastName.StartsWith("A")).ToList();
            ...
            var result03 = _db.Products.Count(p => !p.Price.HasValue);
            ...
            var result05 = _db.Users.Where(s => s.LastName.StartsWith("C")) && s.Products.Any(p => p.Description == null).ToList();
